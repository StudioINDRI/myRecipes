...
RegisterNetEvent('nz-dev:spawnloading-invisibilitamenu')
AddEventHandler('nz-dev:spawnloading-invisibilitamenu', function()
    SetEntityVisible(PlayerPedId(), false, false)
    Invisibile = true
    modalitacinema = true
end)

RegisterNetEvent("nzdev:attivascrittainiziale")
AddEventHandler("nzdev:attivascrittainiziale", function()
	SendNUIMessage({
        action = "open",
    })
end)
...
RegisterNetEvent("nzdev:disattivascrittainiziale")
AddEventHandler("nzdev:disattivascrittainiziale", function()
    SendNUIMessage({
        action = "close",
    })
end)
...
--[[RegisterCommand("as", function()
    ...
    TriggerEvent("nz-spawnloading:Start")
   -- PanoramicaVineWood()
end)
...
RegisterNetEvent('nz-spawnloading:Start')
AddEventHandler('nz-spawnloading:Start', function()
    TriggerEvent("nzdev:attivascrittainiziale")
    modalitacinema = true
    Invisibile = true
    ...
    while true do
        ...
        if ProntoAlloSpawn == true then
            ...
            if IsControlJustPressed(0, 23) then
                Invisibile = false
                modalitacinema = false
                TriggerEvent("nzdev:disattivascrittainiziale")
