...
Citizen.CreateThread(function()
    ...
    TriggerEvent('gridsystem:registerMarker', {
        name = 'fex_wl001_'..Config.Incarico.coords.x,
        pos = vector3(Config.Incarico.coords.x,Config.Incarico.coords.y,Config.Incarico.coords.z),
    ...
    TriggerEvent('gridsystem:registerMarker', {
        name = 'fex_wl001_'..Config.Incarico.spawnpoint.x,
        pos = vector3(Config.Incarico.spawnpoint.x,Config.Incarico.spawnpoint.y,Config.Incarico.spawnpoint.z),
...
function ApriMenuImpiego()
    ...
    elements = elements 
        ...
        if data.current.value ~= nil then
            ...
            ESX.Game.SpawnVehicle(Config.Incarico.vehicle,vector3(Config.Incarico.spawnpoint.x,Config.Incarico.spawnpoint.y,Config.Incarico.spawnpoint.z),Config.Incarico.spawnpoint.h, function(veh)
                                    ...
                                    if IsControlJustReleased(0, 51) then
                                        exports['mythic_progbar']:Progress({
                                            ...
                                            if not cancelled then
                                                TriggerServerEvent('fex_wl001:raccogli', v.RaccoltaLavori.item, v.RaccoltaLavori.count, v.RaccoltaLavori.notify)
                                            end
                                        end)
                                    end
                                end
                                ...
                                if posizionePro < 3.0 then
                                    if IsControlJustReleased(0, 51) then
                                        exports['mythic_progbar']:Progress({
                                            ...
                                            if not cancelled then
                                                TriggerServerEvent('fex_wl001:processa', v.ProcessoLavori.item, v.ProcessoLavori.count, v.RaccoltaLavori.item, v.ProcessoLavori.notify)
                                            end
                                        end)
                                    end
                                end
