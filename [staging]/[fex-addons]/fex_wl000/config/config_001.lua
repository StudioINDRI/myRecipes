...
Config_001.EnablePuntoVenditaBlip = true
Config_001.BlipSprite = 474
Config_001.BlipDisplay = 4
Config_001.BlipScale = 0.90
Config_001.BlipColour = 5
Config_001.BlipName = "Mobilificio"   --Nome attività

Config_001.KeyToOpenShop = 38													
Config_001.ShopMarker = 27 														
Config_001.ShopMarkerColor = { r = 255, g = 255, b = 0, a = 100 } 					
Config_001.ShopMarkerScale = { x = 1.0, y = 1.0, z = 1.0 }  						
Config_001.ShopDraw3DText = "Premi ~g~[E]~s~ per ~y~Import Export~s~"	

--Punto Vendita lista items:
Config_001.ItemsPuntoVendita = {
